...
cfg.pretrained = True
cfg.in_channels = 3
cfg.spec_args = dict(sample_rate=200, n_fft=1024//2, n_mels=128//2, f_min=0.53, f_max=30, win_length=128, hop_length=32)
cfg.spec_args_center = dict(sample_rate=200, n_fft=2048, n_mels=128//2, f_min=0.53, f_max=30, win_length=32, hop_length=8)
cfg.enlarge_len = 2800
cfg.cut_from_large_mel = 0.2

cfg.model_args = dict(drop_rate=0.2, drop_path_rate=0.2)

cfg.conv_stem_k_size = (3, 3)
cfg.conv_stem_stride = (2, 2)
cfg.conv_stem_padding = (1, 1)
